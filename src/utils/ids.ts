...
export const newCarouselId = () => `crs_${Date.now()}_${_idCounter++}`;
export const newAccordionId = () => `acc_${Date.now()}_${_idCounter++}`;
export const newAccordionItemId = () => `acci_${Date.now()}_${_idCounter++}`;
